<template>
  <div class="table" :style="{'background-color':bgcolor}">
    <div class="table-relative">
      ...
      <div style="display:flex" :style="{'bakcground':bgcolor}" id="outputdata" ref="outputdata">
        ...
        <div style="width:100%;">
          <div v-for="(list,L) in tablelist" :key="list.no" :style={height:reverseEdge}>
...
export default {
  ...
  data(){
    return {
      tablelist:[
        {no:1,title:"S",subtitle:"1~100",items:[{img:"",id:1},{img:require("@/assets/logo.png"),id:2},{img:require("@/assets/logo.png"),id:3}]},
        {no:2,title:"A",subtitle:"100~1000",items:[{img:require("@/assets/logo.png"),id:4},{img:require("@/assets/logo.png"),id:5},{img:require("@/assets/logo.png"),id:6}]},
        {no:3,title:"B",subtitle:"1000~10000",items:[{img:require("@/assets/logo.png"),id:7},{img:require("@/assets/logo.png"),id:8},{img:require("@/assets/logo.png"),id:9}]},
      ],
      textcolor:"white",
      itemstatus:0,
